...
def run_model(filepath, model_version):
    # architecture and weights from HDF5

    model = load_model(f"models/model{model_version}.h5")

    img = Image.open(filepath)
    img_size = 224
    img_array = preprocess_input(np.array(img.resize((img_size, img_size))))
...
if __name__=="__main__":
    ...
    run_model(filename, model_version)